...
def check_height(height):
    if height < 80:
        print("you are not tall enough to use this height checker")
        ...
        print("you are about the same height as the uks raoyal sceptre which is roughlt 92cm tall!")
...
height = int(input("Enter your height to the nearest cm"))
check_height(height)